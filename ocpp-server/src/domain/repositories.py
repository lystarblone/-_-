...
class SessionRepo(ABC):
    ...
    @abstractmethod
    def get_session_by_cp_id(self, cp_id: str | ChargePoint.id) -> Session: ...
    @abstractmethod
    def list_sessions(self, cp_id: Optional[str] | Optional[ChargePoint.id], active: Optional[bool], limit: int = 10, offset: int = 0) -> list[Session]: ...
    @abstractmethod
